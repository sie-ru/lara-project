                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <div class="file_upload" style="background-image: url({{ asset('/storage/post_covers' . $post->cover) }}); background-size: cover;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" cols="3" rows="3" type="text" class="form-control">{{ $post->description }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input name="tags[]" type="text" class="form-control" placeholder="#hashtag" value="{{ $post->tags[0]->tag }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input name="tags[]" type="text" class="form-control" placeholder="#hashtag" value="{{ $post->tags[1]->tag }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input name="tags[]" type="text" class="form-control" placeholder="#hashtag" value="{{ $post->tags[2]->tag }}">
                                </div>
                            </div>
                        </div>
                        <!-- /row -->
